...
if false then
    ---@class core.AttributeProxy.Proxy
    local Proxy = {
        key = ""
    }
...
---@param proxies table<any, core.AttributeProxy.Proxy>
...
---@param init function
---@return core.AttributeProxy.Proxy
---@overload fun(key: string): core.AttributeProxy.Proxy
---@overload fun(key: string, getter: function): core.AttributeProxy.Proxy
---@overload fun(key: string, getter: function, setter: function): core.AttributeProxy.Proxy
function M.createProxy(key, getter, setter, init)
    ---@type core.AttributeProxy.Proxy
    return {
        key = key,
