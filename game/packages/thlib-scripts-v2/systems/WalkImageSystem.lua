...
---@class systems.WalkImageSystem.ImageFrame
...
---@class systems.WalkImageSystem.AnimationFrame
---@field image systems.WalkImageSystem.ImageFrame @引用的图像帧
...
---@class systems.WalkImageSystem.AnimationState
---@field frames systems.WalkImageSystem.AnimationFrame[] @帧序列
---@field interval number @帧间隔
---@field loop boolean @是否循环

---@class systems.WalkImageSystem
local M = {}
...
---@return systems.WalkImageSystem
function M.new(obj, texture)
    ---@type systems.WalkImageSystem
    local instance = {}
