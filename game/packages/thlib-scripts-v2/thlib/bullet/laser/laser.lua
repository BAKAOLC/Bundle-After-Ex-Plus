...
local laserCollider = require("thlib.bullet.laser.laserCollider")
...
if false then
    ---@class thlib.bullet.laser.laser.colliderChain
    local chain = {
        ---@type thlib.bullet.laser.laserCollider[] @Child colliders
        colliders = {},
...
---@class thlib.bullet.laser.laser : lstg.GameObject, lstg.Class
local class = lstg.CreateGameObjectClass()

--region Enums
---@enum thlib.bullet.laser.EnumAnchor
local EnumAnchor = {
    Head = 1,
    Center = 2,
    Tail = 3,
...
---@enum thlib.bullet.laser.EnumChangeIndex
...
---@param collider thlib.bullet.laser.laserCollider
...
---@param chains thlib.bullet.laser.laser.colliderChain[]
...
---@param chain thlib.bullet.laser.laser.colliderChain
...
---@return thlib.bullet.laser.laserCollider
...
---@return table<number, thlib.bullet.laser.laser.colliderChain>
function class:getLaserColliderParts()
    ...
    for i = 1, #parts do
        part = parts[i]
        ---@type thlib.bullet.laser.laser.colliderChain
        local chain = {}
...
---Get anchor position
---@param anchor thlib.bullet.laser.EnumAnchor
