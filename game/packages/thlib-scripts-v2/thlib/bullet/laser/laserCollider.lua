...
---@class thlib.bullet.laser.laserCollider : lstg.GameObject
...
---@param on_del fun(master: lstg.GameObject, self: thlib.bullet.laser.laserCollider, args: table<string, any>) @On Del callback
---@param on_kill fun(master: lstg.GameObject, self: thlib.bullet.laser.laserCollider, args: table<string, any>) @On Kill callback
