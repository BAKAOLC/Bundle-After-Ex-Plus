...
---玩家管理器
---用于管理多个玩家实例的创建、更新和销毁
local Player = require("THlib-v2.player.Player")
local PlayerPresets = require("THlib-v2.player.PlayerPresets")
local ObjectManager = require("foundation.ObjectManager")
