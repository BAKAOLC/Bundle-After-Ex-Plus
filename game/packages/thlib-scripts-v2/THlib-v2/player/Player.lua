...
local GameObject = require("foundation.GameObject")
local PlayerConfig = require("THlib-v2.player.PlayerConfig")
...
---@field componentSystem foundation.ComponentSystem
---@field slot number
...
---@field addComponent fun(self: THlib.Player, component: foundation.Component, componentType: string): number
---@field removeComponent fun(self: THlib.Player, componentId: number)
---@field getComponent fun(self: THlib.Player, componentType: string): foundation.Component|nil
...
function Player:setupComponents(componentConfigs)
    ...
    -- 基础系统组件
    local TimerComp = require("foundation.components.TimerComponent")
    local BuffComp = require("foundation.components.BuffComponent")
    local MultiplierComp = require("foundation.components.MultiplierComponent")

    -- 玩家组件
    local StateComp = require("THlib-v2.player.components.StateComponent")
    local InputComp = require("THlib-v2.player.components.InputComponent")
    local ProtectComp = require("THlib-v2.player.components.ProtectComponent")
    local PowerComp = require("THlib-v2.player.components.PowerComponent")
    local MovementComp = require("THlib-v2.player.components.MovementComponent")
    local ShootComp = require("THlib-v2.player.components.ShootComponent")
    local SpellComp = require("THlib-v2.player.components.SpellComponent")
    local DeathAnimComp = require("THlib-v2.player.components.DeathAnimationComponent")
    local ItemCollectComp = require("THlib-v2.player.components.ItemCollectionComponent")
    local TargetingComp = require("THlib-v2.player.components.TargetingComponent")
    local GrazeComp = require("THlib-v2.player.components.GrazeComponent")
    local CollisionComp = require("THlib-v2.player.components.CollisionComponent")
    local OptionComp = require("THlib-v2.player.components.OptionComponent")
    local RespawnComp = require("THlib-v2.player.components.RespawnComponent")
    local WalkImageComp = require("THlib-v2.player.components.WalkImageComponent")
