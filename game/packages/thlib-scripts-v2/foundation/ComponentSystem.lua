...
---@field resolveDependencies fun(self: foundation.Component, gameObject: any)|nil 解析依赖，在此获取其他组件引用
---@field onAdd fun(self: foundation.Component)|nil 添加时回调，在 resolveDependencies 之后
---@field onRemove fun(self: foundation.Component)|nil
---@field update fun(self: foundation.Component)|nil
---@field render fun(self: foundation.Component)|nil 渲染回调

---@class foundation.ComponentSystem
---@field components foundation.Component[] 全部组件数组
---@field updateComponents foundation.Component[]|nil update组件数组（延迟创建）
---@field renderComponents foundation.Component[]|nil 渲染组件数组（延迟创建）
---@field componentCount number 组件数量
---@field updateComponentCount number update组件数量
---@field renderComponentCount number 渲染组件数量
---@field componentsByType table<string, {count: number, [number]: foundation.Component}> 按类型索引的组件
...
---@field addComponent fun(self: foundation.ComponentSystem, component: foundation.Component, componentType: string): number
---@field removeComponent fun(self: foundation.ComponentSystem, componentId: number)
---@field getComponents fun(self: foundation.ComponentSystem, componentType: string): foundation.Component[]|nil
---@field getComponent fun(self: foundation.ComponentSystem, componentType: string): foundation.Component|nil
---@field update fun(self: foundation.ComponentSystem)
---@field render fun(self: foundation.ComponentSystem)
---@field clear fun(self: foundation.ComponentSystem)
---@field setComponentEnabled fun(self: foundation.ComponentSystem, componentId: number, enabled: boolean)

---创建组件系统实例
---@return foundation.ComponentSystem
local function new()
    local system = {
        components = {},
    ...
    ---添加组件
    ---@param component foundation.Component 组件实例
    ...
    ---@return foundation.Component[]|nil
