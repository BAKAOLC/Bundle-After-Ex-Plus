...
---@class foundation.BlueprintUI.Input
local Input = {}
...
---@class foundation.BlueprintUI.Canvas
local Canvas = {}
...
---处理缩放
---@param input foundation.BlueprintUI.Input
...
---@class foundation.BlueprintUI.Renderer
local Renderer = {}
...
---@class foundation.BlueprintUI.Node
local Node = {}
...
---绘制节点
---@param canvas foundation.BlueprintUI.Canvas
...
---@class foundation.BlueprintUI.Connection
local Connection = {}
