---倍率组件
local MultiplierSystem = require("foundation.MultiplierSystem")

---@class foundation.MultiplierComponent : foundation.Component
---@field multipliers foundation.MultiplierSystem

---创建倍率组件
---@param owner any
---@param config table
---@return foundation.MultiplierComponent
local function create(owner, config)
    config = config or {}

    ---@type foundation.MultiplierComponent
    local component = {
        enabled = true,
        executePriority = 99,
        typeName = "multiplier",
